  ...
  return (
    <div className={styles.container}>
      <main className={styles.main}>
        ...
        <div>
          <a href="https://en.wikipedia.org/wiki/Sun" target="_blank" rel="noreferrer">
          ...
          <a href="https://en.wikipedia.org/wiki/Venus" target="_blank" rel="noreferrer">
            <div className={styles.venus}>
              <div className={styles.tooltip}>Venus</div>  
            </div>
          </a>
          <a href="https://en.wikipedia.org/wiki/Earth" target="_blank" rel="noreferrer">
            <div className={styles.earth}>
              <div className={styles.tooltip}>Earth</div>  
            </div>
          </a>
          <a href="https://en.wikipedia.org/wiki/Mars" target="_blank" rel="noreferrer">
            <div className={styles.mars}>
              <div className={styles.tooltip}>Mars</div>  
            </div>
          </a>
          <a href="https://en.wikipedia.org/wiki/Jupiter" target="_blank" rel="noreferrer">
            <div className={styles.jupiter}>
              <div className={styles.tooltip}>Jupiter</div>  
            </div>
          </a>
          <a href="https://en.wikipedia.org/wiki/Saturn" target="_blank" rel="noreferrer">        
            <div className={styles.saturn}>
              <div className={styles.saturnDisc}></div>
              <div className={styles.tooltip}>Saturn</div>  
            </div>          
          </a>
          <a href="https://en.wikipedia.org/wiki/Uranus" target="_blank" rel="noreferrer">
            <div className={styles.uranus}>
              <div className={styles.tooltip}>Uranus</div>
            </div>
          </a>
          <a href="https://en.wikipedia.org/wiki/Neptune" target="_blank" rel="noreferrer">
